...
/**
 * Configuración de Spring Security para el Servicio de Operaciones.
 * 
 * Esta configuración:
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                // ===== Endpoints de API =====
                // Consultas de estado - usuarios autenticados y transportistas
                .requestMatchers(HttpMethod.GET, "/api/solicitudes/*/estado").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/contenedores/*/estado").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/tramos/transportistas/**").hasAnyRole("TRANSPORTISTA", "OPERACIONES_MANAGER", "ADMIN")
                
                // Lectura general (GET) - cualquier usuario autenticado
                ...
                // Actualización (PUT y PATCH) - managers y transportistas para sus tramos
                .requestMatchers(HttpMethod.PUT, "/api/tramos/*/iniciar", "/api/tramos/*/finalizar")
                    .hasAnyRole("TRANSPORTISTA", "OPERACIONES_MANAGER", "ADMIN")
    ...
    public Converter<Jwt, AbstractAuthenticationToken> jwtAuthenticationConverter() {
        ...
        converter.setJwtGrantedAuthoritiesConverter(jwt -> {
            ...
            if (resourceAccess != null) {
                ...
                for (String clientId : List.of("servicio-operaciones", "tpi-api-gateway")) {
